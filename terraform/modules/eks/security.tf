...
resource "aws_security_group" "eks_cluster_sg" {
  ...
  vpc_id      = var.vpc_id
  description = "Security group for the EKS cluster, allowing all inbound traffic from any source within the security group and permits all outbound traffic."
